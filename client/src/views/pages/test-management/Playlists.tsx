...
const Playlists = () => {
  ...
  return (
    <Grid container spacing={3}>
              ...
              >
                ...
                {selectedPlaylistItem?.mode === "Public" ? (
                  <Fragment>
                    ...
                    <Typography variant="h6"> 11/30/2022 @08:16pm </Typography>
                  </Fragment>
                ) : null}
              </Box>
            </Box>
      ...
      >
        <Box sx={{ ...theme.typography.basicDarkModeBg3 }}>
          <AppBar
            enableColorOnDark
          ...
          >
            <Toolbar>
              ...
              <Typography sx={{ ml: 2, flex: 1, color: "white" }} variant="h4">
                All Test Cases
              </Typography>
              <CustomButton
                name="Save"
          ...
          <Grid item md={12} xs={12} sm={12} sx={{ m: "2rem 4rem 0 3rem" }}>
            <Grid container spacing={2}>
              <Grid item md={12} xs={12} sm={12}>
                <Box display="flex" flexDirection="column">
                  <Box
